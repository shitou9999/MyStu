package com.stu.com.app2.BadgeActionProvider;
 ...
 * toobar显示圆点提示功能，自定义
 */
public class ch01_BadgeActitvty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ch01__badge_actitvty);
    ...
    private BadgeActionProvider.OnClickListener onClickListener = new BadgeActionProvider.OnClickListener() {
        ...
        public void onClick(int what) {
            if (what == DELETE_WHAT) {
                Toast.makeText(ch01_BadgeActitvty.this, "删除", Toast.LENGTH_SHORT).show();
            } else if (what == PIC_WHAT) {
                Toast.makeText(ch01_BadgeActitvty.this, "图片", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_main_badge, menu);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        mDeleteBadgeActionProvider.setIcon(R.mipmap.ic_back);
        mPicBadgeActionProvider.setIcon(R.mipmap.ic_del);
    }
}
