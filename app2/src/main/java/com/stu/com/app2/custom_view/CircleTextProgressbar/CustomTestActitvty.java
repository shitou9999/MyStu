 ...
 * 目前已知的兼容问题修复
 * 目前CircleTextProgressbar在ReletiveLayot中高度会变大，导致进度条会有一点点扁。修复方法如下：
 如果你要在ReletiveLayot中使用CircleTextProgressbar，就不要重写onMeasure()方法，
 然后在xml中指定CircleTextProgressbar的宽高就好，比如都指定为50dp，然后就没有问题啦。
 */
public class CustomTestActitvty extends AppCompatActivity{
    /**
     * 默认类型。
     */
