...
public class RecordActivity extends Activity {
    ...
    private Button cancelButton;//点击取消录音
    private Button saveButton;//点击保存录音
        ...
        recordButton.setAudioFinishRecorderListener(new AudioRecordButton.AudioFinishRecorderListener() {
            ...
            public void onFinished(float seconds, String filePath) {
                ...
                RecordActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        recorderTime.setText(Math.round(recorder.time) + "\"");//取整
        ...
        recorderLength.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null == recorder) {
                    ...
                    AnimationDrawable drawable = (AnimationDrawable) idRecorderAnim.getBackground();
                    drawable.start();

                    // 播放音频
                    MediaManager.playSound(recorder.filePathString, new MediaPlayer.OnCompletionListener() {
