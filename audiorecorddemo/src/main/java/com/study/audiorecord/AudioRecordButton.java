...
public class AudioRecordButton extends Button implements AudioManager.AudioStageListener {
    ...
    private static final int STATE_WANT_TO_CANCEL = 3;//cancel
    private static final int DISTANCE_Y_CANCEL = 50;//distance
...
//        String dir = ApplicationGlobal.basePath + "MaiBei_record_audios";
        String dir =  Environment.getExternalStorageDirectory()+ "/MaiBei_record_audios";
    ...
    private void changeState(int state) {
        if (mCurrentState != state) {
            ...
            switch (mCurrentState) {
                case STATE_NORMAL:
                    this.setBackgroundResource(R.drawable.button_record_normal);
                    this.setText("按住 说话");
                    break;
